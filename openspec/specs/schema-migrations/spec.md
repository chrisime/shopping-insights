...
## Purpose
Schema lifecycle management via Alembic: baseline initialization, ordered application of pending migrations, reversible migrations, and retirement of the self-written migration runner.

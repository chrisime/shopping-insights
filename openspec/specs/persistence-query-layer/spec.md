# persistence-query-layer Specification

## Purpose
Unified SQLAlchemy Core persistence and analysis layer that stores receipts, retrieves them in canonical form, and answers analytical KPI queries over a single database.

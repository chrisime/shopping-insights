# Workflows Architecture Specification

## Purpose
Unify retailer local-import behavior behind a single shared path, remove stacked pipeline abstractions, and avoid interface-only abstractions.
